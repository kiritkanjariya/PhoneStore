                    ...
                    <form action="{{ route('reset_password',$email) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text bg-white border-start-0" onclick="togglePassword('new_password', this)">
                                    <i class="fa fa-eye"></i>
                                </span>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" id="confirm_password"
                                    ...
                                    data-validation="required confirmPassword" data-password-id="new_password" value="KIri23@#">
