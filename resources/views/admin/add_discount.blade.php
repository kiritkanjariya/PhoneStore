            ...
            <div class="card shadow-lg rounded-4">
                ...
                <form action="{{ route('discount_added') }}" method="POST" class="p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="original_price" name="original_price" data-validation="required numeric" placeholder="Enter Original Price">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="discount_percentage" name="discount_percentage" placeholder="Enter Discount Percentage" data-validation="required numeric min max" data-min="1" data-max="100">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="discounted_price" name="discounted_price" placeholder="Enter Discounted Price" data-validation="required numeric">
                        <div class="error" id="discounted_priceError"></div>
                    </div>

                    <div class="mb-3">
                        <label for="discount_label" class="form-label fw-semibold">Discount Label</label>
                        <input type="text" class="form-control" id="discount_label" name="discount_label" placeholder="Enter Discount Label" data-validation="required">
