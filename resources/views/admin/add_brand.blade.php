    ...
    <div class="col-md-6">
        <div class="container mt-5 mb-5">
            <div class="card shadow-lg rounded-4">
                ...
                <form action="{{ route('brand_added') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-4">
                        <label for="brand_name" class="form-label fw-semibold">Brand Name</label>
                        <input type="text" class="form-control" id="brand_name" name="brand_name" data-validation="required" placeholder="Enter Brand Name">
