            ...
            <div class="card shadow-lg rounded-4">
                ...
                <form action="{{ route('product_added') }}" method="POST" enctype="multipart/form-data" class="p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" data-validation="required alpha min max" data-min="2" data-max="50" placeholder="Enter Product name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="screen_size" name="screen_size" placeholder="Enter Screen Size" data-validation="required">
                        <div class="error" id="screen_sizeError"></div>
                    </div>
                    <div class="mb-3">
                        <label for="stock" class="form-label fw-semibold">Stock</label>
                        <input type="text" class="form-control" id="stock" name="stock" placeholder="Enter Stock" data-validation="required">
