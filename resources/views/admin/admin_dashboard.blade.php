                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">100</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">65</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">35</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <h6 class="fw-semibold">New User</h6>
                            <p class="fw-bold text-secondary">16</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">₹30,00,000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">₹16,000</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">30</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">10</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">20</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm hover-shadow">
                        <div class="card-body text-center py-4">
                            ...
                            <p class="fw-bold text-secondary">5</p>
                        </div>
                    </div>
                </div>
            </div>
