    ...
    <div class="col-md-6">
        <div class="container mt-5 mb-5">
            <div class="card shadow-lg rounded-4">
                ...
                <form action="{{ route('offer_updated') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-3">
                        <label for="offer_title" class="form-label fw-semibold">Offer Title</label>
                        <input type="text" class="form-control" id="offer_title" name="offer_title" data-validation="required" placeholder="New Year Sale">
                        <div class="error" id="offer_titleError"></div>
                    </div>

                    <div class="mb-4">
                        <label for="offer_code" class="form-label fw-semibold">Offer Code</label>
                        <input type="text" class="form-control" id="offer_code" name="offer_code" data-validation="required" placeholder="NEWYEAR2023">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="discount_percentage" name="discount_percentage" data-validation="required" placeholder="10%">
                        <div class="error" id="discount_percentageError"></div>
                    </div>

                    <div class="mb-3">
                        <label for="start_date" class="form-label fw-semibold">Start Date</label>
                        <input type="date" class="form-control" id="start_date" name="start_date" data-validation="required">
                        <div class="error" id="start_dateError"></div>
                    </div>
                    <div class="mb-3">
                        <label for="end_date" class="form-label fw-semibold">End Date</label>
                        <input type="date" class="form-control" id="end_date" name="end_date" data-validation="required">
