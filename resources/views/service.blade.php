            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        ...
                        <h5 class="service-title">Expert Phone Repair</h5>
                        <p class="service-text">Cracked screen or battery issues? Our certified technicians provide fast,
                            reliable repairs for all major brands to get your device working like new.</p>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        <div class="service-icon-wrapper"><i class="bi bi-arrow-repeat"></i></div>
                        <h5 class="service-title">Easy Trade-In Program</h5>
                        <p class="service-text">Upgrade and save! Get an instant, fair valuation for your old phone and
                            apply the credit towards the purchase of a brand new device from our store.</p>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        <div class="service-icon-wrapper"><i class="bi bi-files"></i></div>
                        <h5 class="service-title">Data Transfer & Setup</h5>
                        <p class="service-text">We make switching phones hassle-free. Our team will securely transfer all
                            your contacts, photos, and data from your old device to your new one.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        ...
                        <h5 class="service-title">NextPhone Care+</h5>
                        <p class="service-text">Protect your investment with our extended warranty and insurance plans,
                            covering accidental damage, hardware issues, and more for total peace of mind.</p>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        <div class="service-icon-wrapper"><i class="bi bi-patch-check-fill"></i></div>
                        <h5 class="service-title">Certified Refurbished</h5>
                        <p class="service-text">Get premium devices at unbeatable prices. Our certified pre-owned phones
                            undergo rigorous testing to ensure they meet the highest quality standards.</p>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 fade-in-section">
                    <div class="service-card-v2">
                        <div class="service-icon-wrapper"><i class="bi bi-building"></i></div>
                        <h5 class="service-title">Corporate & Business</h5>
                        <p class="service-text">Equip your team with the best technology. We offer bulk pricing, custom
                            device solutions, and dedicated support for our corporate clients.</p>
                    </div>
                </div>
