                    ...
                    <div class="row g-3">
                        ...
                        <div class="mb-3 mt-2">
                            ...
                            <input type="date" class="form-control" id="delivered_date" name="delivered_date"
                                value="{{ \Carbon\Carbon::parse(now()->addDays(3)->format(format: 'Ymd'))->format('Y-m-d') }}" data-validation="required">
                            <div class="error" id="delivered_dateError"></div>
                        </div>
                    </div>
            ...
            "config": {
                "display": {
                    "blocks": {
                        "upi": {
                            "name": "Pay with UPI",
                            "order": ["google_pay", "phonepe", "upi"]
                        },
                        "banks": {
                            "name": "Pay with Netbanking",
                            "order": ["hdfc", "icici", "sbi", "axis"]
                        }
                    },
                    "sequence": ["block.upi", "block.banks", "card", "wallet", "paylater"],
                    "preferences": {
