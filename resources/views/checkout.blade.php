        ...
        <div class="col-lg-8">
            <div class="checkout-form-panel">
                ...
                <form action="/Success" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="fullName" name="full_name"
                                placeholder="Enter your full name" data-validation="required alpha min max"
                                data-min="2" data-max="50" value="{{ session('user')->name }}">
                    ...
                    <button class="w-100 btn btn-checkout-v2" type="submit">Continue to Checkout</button>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="summary-box-v2">
                <h4 class="summary-title d-flex justify-content-between align-items-center">
                    <span>Your Cart</span>
                    <span class="badge bg-secondary rounded-pill">{{ $cart_items->count() }}</span>
                </h4>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="summary-product-item d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('img/product-images/' . $cart_item->product->image) }}" alt="Product" width="50" class="me-2">
            ...
            <div style="background-color: #f8f9fa; padding: 8px 10px; margin-top: 10px;">
                ...
                <div class="d-flex justify-content-between">
                    <input class="form-control w-50" type="text" placeholder="Enter Coupon code">
